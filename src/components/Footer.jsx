...
const Footer = () => {
  return (
      ...
      <div className='w-full mt-24 bg-gray-900 text-gray-300 py-2 px-2'>
         <div className='max-w-[1400px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-8 px-4 text-center'>
            <div>
            ...
            <div className='col-span-2 py-8 md:pt-2'>
               ...
               <button className='p-2 mb-4 rounded-md' type='' onClick={(event) => event.preventDefault()}>Subscribe</button>
               </form>
          </div>
         </div>

         <div className='flex flex-col max-w-[1400px] px-2 justify-center py-4 mx-auto sm:flex-row text-center text-gray-500'>
            <p className='py-4'>2023 VACATIONS+, LLC. All rights reserved</p>
         </div>
      </div>
